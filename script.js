$(document).ready(function() {
	...
	$("#search").click(function() {
		...
		var query = $("#query").val();
		var API_KEY = "AIzaSyCUwT4UR5Wnhglu5GtpHxcARkK9Na9uePA";
		var url = "https://www.googleapis.com/youtube/v3/search?part=snippet&type=video&q="+query+"&key="+API_KEY;
		var result = "";
		...
		.then(data => {
			for (var i = 0; i < data.items.length; i++)
			{
				...
				var channel_owner = data.items[i].snippet.channelTitle;
